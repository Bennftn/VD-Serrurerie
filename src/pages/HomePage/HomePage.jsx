  ...
  return (
    <>
      <Helmet>
          ...
          {/* Schema.org - LocalBusiness (OPTIMISÉ pour SEO local) */}
          <script type="application/ld+json">
            {JSON.stringify({
              "@context": "https://schema.org",
              "@type": "LocalBusiness",
              "name": "VD Serrurerie",
              "image": "https://vdserrurerie.com/logo.png",
              "description": "Serrurerie, métallerie et ferronnerie d'art depuis 2019. Portails en fer forgé, ouverture de porte, garde-corps sur mesure.",
              "url": "https://vdserrurerie.com",
              "email": "vdserrurerie@gmail.com",
              "address": {
                "@type": "PostalAddress",
                "streetAddress": "13 Rue des Charmes",
